sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.pruebasLina.controller.Clientes", {
		...
		_onFioriListReportActionButtonPress: function(oEvent) {
			...
			return new Promise(function(fnResolve) {
				...
				this.doNavigate("Estadisticas", oBindingContext, fnResolve, "");
			}.bind(this)).catch(function(err) {
				if (err !== undefined) {
					MessageBox.error(err.message);
				}
		...
		onExit: function() {
			...
			var aControls = [{
				"controlId": "Fiori_ListReport_ListReport_0-filterBars-Fiori_ListReport_FilterBar-1-wkn0m6k5a84w8opzja0s3fco10_S10-filters-Fiori_ListReport_ComboBoxFilter-1716544004992---1",
				"groups": ["items"]
			}, {
				"controlId": "Fiori_ListReport_ListReport_0-content-Fiori_ListReport_Table-1-wkn0m6k5a84w8opzja0s3fco10_S10",
				"groups": ["items"]
			}];
